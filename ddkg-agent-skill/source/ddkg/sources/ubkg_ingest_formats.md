...
## Glossary
The [Glossary](https://ubkg.docs.xconsortia.org/glossary/) page describes terms that this guide uses that are relevant to assertions or knowledge graphs. 
...
UBKG Edge/Node file, is [here](https://ubkg.docs.xconsortia.org/pubchem/).
